...
- 찾기 결과를 리스트로 확인 후 파일 바로 열기 / 경로 복사 가능
...
### ↩ 되돌리기
- 마지막 작업을 이전 상태로 즉시 복구

### 🎨 테마 커스터마이징
- 색상 항목별 개별 설정
- 다크 블루 / 시스템 테마 / 기본값 초기화
  
![옵션(테마설정)](./images/SentenceReplace-v80_002.png)
...
├── SentenceReplacer.spec   # PyInstaller 빌드 스펙
...
| 버전 | 내용 |
|---|---|
| V0.80 | 검색 결과 리스트 UI, 파일 열기/경로 복사, 편집기 등록 기능 추가 |
| V0.72 | 기존 기능 안정화 |

전체 변경 이력은 [업데이트노트.md](./업데이트노트.md) 참고
...
**재와니**
- 블로그: [blog.naver.com/akrsodhk](https://blog.naver.com/akrsodhk/)
